...
Niter = c(1,2,3,10,15,20,30,40,50,60,70,80,90,100,300) * 1e3,
Nburn = 2e5, thin = 1e2, sa2l = .5, sa2m = 1, at = 10, bt = 1, al = 25, bl = 6,
ql = .025, qu = .975, plot.name = "example", sample.return = F)
## We set the number of iterations small here for illustration purpose
## We suggest increase it to the scale of 1e7
```
